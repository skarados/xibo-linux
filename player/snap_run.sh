...
export GST_PLUGIN_PATH=$SNAP/usr/lib/arm64-linux-gnu/gstreamer-1.0
export GST_PLUGIN_SYSTEM_PATH=$SNAP/usr/lib/arm64-linux-gnu/gstreamer-1.0
export GST_PLUGIN_SCANNER=$SNAP/usr/lib/arm64-linux-gnu/gstreamer1.0/gstreamer-1.0/gst-plugin-scanner
